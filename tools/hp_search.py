...
parser.add_argument('--snapshot', type=str, default='snapshot/checkpoint_e16_batchsize48.pth', help='snapshot of model')
parser.add_argument('--dataset', type=str, default='VOT2018', help='dataset name to eval')
parser.add_argument('--penalty-k', default='0.03,0.08,0.01', type=parse_range)
parser.add_argument('--lr', default='0.43,0.50,0.01', type=parse_range)
parser.add_argument('--window-influence', default='0.37,0.41,0.01', type=parse_range)
